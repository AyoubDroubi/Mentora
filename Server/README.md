...
### ?? ???? Domain
- [Domain Overview](docs/domain/01-DOMAIN-OVERVIEW.md)
- [Enums Reference](docs/domain/03-ENUMS-REFERENCE.md)

### ?? API
- [API Quick Reference](docs/API-QUICK-REFERENCE.md)
- [Authentication Module](docs/MODULE-1-AUTHENTICATION.md)
- [Swagger Auto-Enable](docs/SWAGGER-AUTO-ENABLE.md)
